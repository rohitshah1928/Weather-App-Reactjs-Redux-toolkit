...
import { fetchWeatherAction } from "./redux/slices/whetherSlices";
  ...
  return (
    <div>
      <section class="relative bg-gray-900  min-h-screen">
        ...
        {/* Content goes here */}
        {
          loading ? <h1 className="text-gray-400 text-4xl text-center">Loading Please wait...</h1> : error ? <h1 className="text-red-400 text-2xl text-center">{error?.message}</h1> : (
